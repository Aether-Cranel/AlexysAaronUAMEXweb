...
<head>
    ...
    <title>Casa de las Diligencias UAEMéx</title>
    <style>
        body {
            margin: 0;
...
<body>
    <header>
        <img src="img/logo.jpg" alt="Logo UAEMéx">
    ...
    <div class="container">
        <div class="content">
            ...
            <section id="eventos">
                ...
                <ul>
                    <li>Conciertos Didácticos como el de Jazzsontitlán</li>
        ...
        <div class="sidebar">
            ...
            <p><strong>Teléfonos:</strong> 722 215 69 19 / 722 213 16 87</p>
